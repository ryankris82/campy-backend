...
model = api.model("Location",
                        {
                        "address": fields.String(required=True, description="Location address.", example="1632 86th Ave NE"),
                        "city": fields.String(required=True, description="Location city.", example="Everett"),
                        "state": fields.String(required=True, description="Location state.", example="WA"),
                        "gps_coords": fields.String(required=True, description="Location GPS Coordinates.", example="47.987 | -122.133"),
                        "image_urls": fields.List(fields.String( description="Location image URLs.", example="image1.png, image2.png, ...")),
                        "website": fields.String( description="Location website.", example="www.bestplace.com"),
                        "description": fields.String(required=True, description="Location Description.", example="This the place where you will enjoy relaxing for a night or two!!!"),
                        "host_notes": fields.String( description="Location Host notes.", example="No smoking allowed on the area"),
                        "active": fields.Boolean( description="Location active.", example=True),
                        "user_id": fields.Integer(required=True, description="Location Host User Id.", example=1),

                        "electric_hookup":  fields.Boolean(required=True, description="Does location have electric hookup?", example=True),
                        "water_hookup":  fields.Boolean(required=True, description="Does location have water hookup?", example=True),
                        "septic_hookup":  fields.Boolean(required=True, description="Does location have septic hookup?", example=True),
                        "assigned_parking":  fields.Boolean(required=True, description="Does location have an assigned parking?", example=True),
                        "tow_vehicle_parking":  fields.Boolean(required=True, description="Does location have a tow vehicle parking?", example=True),
                        "trash_removal":  fields.Boolean(required=True, description="Does location have trash removal?", example=True),
                        "water_front":  fields.Boolean(required=True, description="Is location a water front?", example=True),
                        "pets_allowed":  fields.Boolean(required=True, description="Does location allow pets?", example=True),
                        "internet_access":  fields.Boolean(required=True, description="Does location have internet access?", example=True),
                        "tow_vehicle_parking":  fields.Boolean(required=True, description="Does location have a tow vehicle parking?", example=True),

                        "rv_compatible":  fields.Boolean(required=True, description="Is location  RV compatible.", example=True),
                        "generators_allowed":  fields.Boolean(required=True, description="Does location allow generators?", example=True),
                        "fires_allowed":  fields.Boolean(required=True, description="Does location allow fires?", example=True),
                        "max_days":  fields.Integer(required=True, description="Location's maximum stay days.", example=3),
                        "pad_type":  fields.String(required=True, description="Location's pad type.", example="Gravel"),
                        }
                )
